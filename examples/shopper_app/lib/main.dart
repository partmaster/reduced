  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProxyProvider<CartModel, ValueNotifier<CartModel>>(
          create: (context) => ValueNotifier<CartModel>(CartModel()),
          update: (context, cart, notifier) {
            if (notifier == null) throw ArgumentError.notNull('notifier');
            notifier.value = cart;
            return notifier;
          },
        )
