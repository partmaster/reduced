...
import 'package:flutter/gestures.dart' show DragEndDetails, DragStartDetails, DragUpdateDetails, ForcePressDetails, GestureRecognizer, LongPressEndDetails, LongPressMoveUpdateDetails, LongPressStartDetails, PointerCancelEvent, PointerDownEvent, PointerMoveEvent, PointerUpEvent, ScaleEndDetails, ScaleStartDetails, ScaleUpdateDetails, TapDownDetails, TapUpDetails, Velocity;
import 'package:flutter/rendering.dart' show ImageSizeInfo, Shader, TextSelection;
import 'package:flutter/services.dart' show PlatformViewController, SelectionChangedCause, TextEditingValue;
import 'package:flutter/widgets.dart' show Action, AnimationStatus, BoxConstraints, BuildContext, DismissDirection, DismissUpdateDetails, DragDownDetails, DragTargetDetails, Draggable, DraggableDetails, Element, FocusNode, ImageChunkEvent, ImageInfo, InlineSpan, Intent, Key, KeyEventResult, NavigatorState, Notification, PlatformMenuItem, PlatformViewCreationParams, RawKeyEvent, Route, RouteSettings, ScrollIncrementDetails, ScrollNotification, Tween, TweenConstructor, Widget, visibleForTesting;
import 'package:reduced/reduced.dart' show Callable, Callable1, Callable2, Callable3;

/// typedef ActionListenerCallback = void Function(Action<Intent> action);
typedef ActionListenerObjectCallable = Callable1<void, Action<Intent>>;
