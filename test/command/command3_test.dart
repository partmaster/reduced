...
void main() {
  test('Action3 call test', () {
    ...
    final objectUnterTest = Command3(
      store,
      MockEvent3(),
    );
  ...
  test('Action3 hashCode test', () {
    ...
    final objectUnterTest11 = Command3(
      store1,
      reducer1,
    );
    final objectUnterTest12 = Command3(
      store1,
      reducer2,
    );
    final objectUnterTest21 = Command3(
      store2,
      reducer1,
    );
    final objectUnterTest22 = Command3(
      store1,
      reducer1,
    );
