...
void main() {
  test('Reducer3Adapter call test', () {
    ...
    final objectUnderTest = Event3Adapter(reducer, '1', '2', '3');
  ...
  test('Reducer3Adapter hashCode test', () {
    ...
    final objectUnderTest11 = Event3Adapter(reducer1, '1', '2', '3');
    final objectUnderTest12 = Event3Adapter(reducer1, '2', '3', '4');
    final objectUnderTest21 = Event3Adapter(reducer2, '1', '2', '3');
    final objectUnderTest22 = Event3Adapter(reducer1, '1', '2', '3');
