...
void main() {
  test('Reducer2Adapter call test', () {
    ...
    final objectUnderTest = Reducer2Adapter(reducer, '1', '2');
  ...
  test('Reducer2Adapter hashCode test', () {
    ...
    final objectUnderTest11 = Reducer2Adapter(reducer1, '1', '2');
    final objectUnderTest12 = Reducer2Adapter(reducer1, '2', '3');
