...
void main() {
  ...
  test('Reducer3Adapter hashCode test', () {
    ...
    final objectUnderTest11 =
        Reducer3Adapter(reducer1, '1', '2', '3');
    final objectUnderTest12 =
        Reducer3Adapter(reducer1, '2', '3', '4');
    final objectUnderTest21 =
        Reducer3Adapter(reducer2, '1', '2', '3');
    final objectUnderTest22 =
        Reducer3Adapter(reducer1, '1', '2', '3');
