...
void main() {
  test('ReducibleProxy init test', () {
    ...
    final objectUnderTest = ReducibleProxy(() => reducible.state, reducible.reduce, reducible);
  ...
  test('ReducibleProxy operator== test', () {
    ...
    final objectUnderTest1 = ReducibleProxy(() => reducible1.state, reducible1.reduce, reducible1);
    final objectUnderTest3 = ReducibleProxy(() => reducible1.state, reducible1.reduce, reducible1);
    final reducible2 = MockReducible('2');
    final objectUnderTest2 = ReducibleProxy(() => reducible2.state, reducible2.reduce, reducible2);
